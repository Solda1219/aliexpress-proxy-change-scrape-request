...
_SEARCH_URL = "https://aliexpress.ru/wholesale?catId=0&initiative_id=SB_20201112042158&SearchText={string}"
_PAGE_SEARCH_URL = "https://aliexpress.ru/wholesale?catId=0&initiative_id=SB_20201112042158&SearchText={string}&SortType=default&page={page}"  
_ITEM_URL = "https://aliexpress.ru/item/{product_id}.html"
_BASE_URL = "https://www.aliexpress.ru"
...
class AliexpressClient(object):
    ...
    def _get(self, url, timeout = 10, scrolldown = -1, retries=0, retry_limit=5, rotate_proxies=False ):
        ...
        try:
            ...
            ret = self.session.get(url, timeout=10)
            if scrolldown == -1:
    ...
    def _get_products_page(self, page, keywords="", search_url="", max_product_nb=100):
        page_url = self._get_page_search_url(string, page)
